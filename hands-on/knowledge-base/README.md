...
\* \*\*search\_knowledge\*\* — searches the documents for a given word or phrase and returns the relevant information.

\* \*\*get\_document\*\* — returns the complete contents of a particular document.
